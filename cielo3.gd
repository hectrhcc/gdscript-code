...
func _ready():
	hide_textbox()
	add_text("guiado por el cielo te adentras por un sendero dentro del oscuro bosque\n\navanzas y poco a poco logras percibir\nuna especie de ruina aparentemente abandonada")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/explorarobosque.tscn")
