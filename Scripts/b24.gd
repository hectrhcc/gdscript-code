...
func _ready():
	hide_textbox()
	add_text("La magia es el eco de la antigua sabiduria,\n un lenguaje ancestral que solo unos pocos pueden comprender")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/b25.tscn")
