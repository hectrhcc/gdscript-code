...
func _ready():
	hide_textbox()
	add_text("La magia es un baile entre la mente y el espiritu,\nentre la luz y la sombra.\nDomina tu voluntad y mantén tu equiibrio interno\npara canalizar con éxito la energía mágica que te rodea")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/b13.tscn")
