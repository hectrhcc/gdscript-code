...
func _ready():
	...
	hide_textbox()
	add_text("Un Tabla Sophia es un mecanismo magico\nconjurado con el proposito de comunicarse\ncon la entidad atrapada en este cartucho")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/tabla.tscn")
