...
func _ready():
	hide_textbox()
	add_text("En el reino de la magia, cada paso es un baile,\ncada palabra es un conjuro y\ncada mirada es un portal hacia lo desconocido")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/b33.tscn")
