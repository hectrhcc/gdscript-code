...
func _ready():
	hide_textbox()
	add_text("La magia no conoce límites ni barreras,\ntrasciende el tiempo y el espacio. Siente la energía fluir\na través de ti y desata su poder en cada conjuro")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/b9.tscn")
