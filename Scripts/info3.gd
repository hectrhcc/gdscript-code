...
func _ready():
	...
	hide_textbox()
	add_text("Con o sin entrar en un trance mental,\n la tabla sophia tiene como objetivo\nque las personas que integran la sesión\nse contacten con espíritus\no <<almas en pena>>, difuntos y también demonios,\nes decir, ángeles que cayeron en\ndesgracia antes de que Dios crease al humano.")
