...
func _ready():
	hide_textbox()
	add_text("El conocimiento es la llave que desbloquea\nlas puertas del mundo místico.\nAprende, estudia y descubre los secretos ocultos\nque aguardan en las páginas de los antiguos grimorios")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/b8.tscn")
