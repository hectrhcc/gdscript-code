...
func _ready():
	hide_textbox()
	add_text("La magia no es solo el arte de realizar hechizos,\nsino también el arte\nde ser consciente de la magia  que existe en cada instante de la vida.\nAbre tus ojos y maravíllate\nante la maravilla que te rodea")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/b15.tscn")
