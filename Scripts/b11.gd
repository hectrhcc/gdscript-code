...
func _ready():
	hide_textbox()
	add_text("Los hechizos son como las palabras en un libro de hechicería,\npero solo aquellos que comprenden su verdadero\n significado y lo pronuncian con intención\nlograrán despertar su auténtico poder")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/b12.tscn")
