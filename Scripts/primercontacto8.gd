...
func _ready():
	...
	hide_textbox()
	add_text("Descubrimos que la entidad con la cual interactuamos\nesta consciente del tiempo y el espacio\na escala humana")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/primercontacto9.tscn")
