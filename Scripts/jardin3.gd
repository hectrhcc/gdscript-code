...
func _ready():
	...
	hide_textbox()
	add_text("La Atmosfera dentro de las Ruinas es muy Pacifica\nTe adentras silenciosamente para\n no interferir con la energía del Lugar")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/jardin4.tscn")
