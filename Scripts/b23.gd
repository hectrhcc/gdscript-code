...
func _ready():
	hide_textbox()
	add_text("Los secretos de la magia están ocultos en cada rincón del universo,\nsolo debes aprender a escuchar su susurro")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/b24.tscn")
