...
func _ready():
	hide_textbox()
	add_text("ATREVETE A SENTIR LO QUE OCURRE Y HABITA EN TUS ESPACIOS COTIDIANOS\nDE A POCO DESARROLLA TU INTUICION PARA MOVERTE EN LA DIRECCION MAGICA PLENA CONSCIENCIA")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/b5.tscn")
