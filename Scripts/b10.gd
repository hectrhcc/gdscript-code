...
func _ready():
	hide_textbox()
	add_text("No temas al fracaso, los errores son solo oportunidades\npara aprender y crecer\nen tu dominio de las artes místicas.\nPersiste y nunca dejes de explorar las maravillas del mundo mágico")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/b11.tscn")
