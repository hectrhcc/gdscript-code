...
func _ready():
	hide_textbox()
	add_text("has encontrado una carta\n\nabrir y leer\n\nabandonar las pertenencias\nhuir al bosque")	
func hide_textbox():
	label.text=""
...
func seleccion(ingreso):
	if(opc_act==0):
		CambioEscena.cambio_escena("res://scenes/suelo13.tscn")
	elif(opc_act==1):
		CambioEscena.cambio_escena("res://scenes/abandonar.tscn")
	elif(opc_act==2):
