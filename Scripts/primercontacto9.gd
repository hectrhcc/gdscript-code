...
func _ready():
	...
	hide_textbox()
	add_text("Esto quiere decir que la información que usted obtenga\npueden tener relacion con sucesos reales que han ocurrido,\nque estan ocurriendo o que aun no ocurren")
