...
func _ready():
	hide_textbox()
	add_text("El verdadero mago no se limita a controlar\nlas fuerzas sobrenaturales,\nsino a armonizarlas con el flujo natural del universo.\nEn ese equilibrio se encuentra la esencia de la verdadera magia")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/b10.tscn")
