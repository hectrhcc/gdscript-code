...
func _ready():
	hide_textbox()
	add_text("Las estrellas y astros del cielo\ntienen el poder de comunicarte información valiosa\ncomo tu localización o las longitudes de un mapa")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/bosque3.tscn")
