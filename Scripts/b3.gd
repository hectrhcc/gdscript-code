...
func _ready():
	hide_textbox()
	add_text("EL AIRE NO HAY QUE CREERLO, HAY QUE RESPIRARLO\n\nSIN AIRE MORIMOS\n\nLA MAGIA ES EXACTAMENTE IGUAL, AL IGUAL QUE EL AIRE,\n NO LA VEZ, NO LA TOCAS... PERO LA SIENTES")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/b4.tscn")
