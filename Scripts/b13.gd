...
func _ready():
	hide_textbox()
	add_text("El poder de la magia yace en la conexión con la naturaleza.\nEscucha el susurro de los árboles,\nsiente la fuerzas del viento\ny abraza la esencia de la tierra para encontrar\ntu verdadera fuerza interior")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/b14.tscn")
