...
func _ready():
	hide_textbox()
	add_text("Al igual que tu\nhace un tiempo atras hubo un viajero\nque se adentro a lo profundo\nde este mismo bosque misterioso")
...
func _on_Timer_timeout():
	CambioEscena.cambio_escena("res://scenes/suelo8.tscn")
