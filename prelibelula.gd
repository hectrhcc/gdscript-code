...
var iniciorandom_libelula = random_scene_libelula();
...
func _on_Timer_timeout():
	...
	CambioEscena.cambio_escena(iniciorandom_libelula)

#export (PackedScene) var chinita1
	
func random_scene_libelula() -> String:
	randomize()
	var scenes_list: Array = [
		   "res://scenes/libelula1.tscn",
		   "res://scenes/libelula2.tscn",
		   #"res://scenes/libelula3.tscn",
		   #"res://scenes/libelula4.tscn",
		   #"res://scenes/libelula5.tscn",
		   #"res://scenes/libelula6.tscn",
		   #"res://scenes/libelula7.tscn",
		   #"res://scenes/libelula8.tscn",
		   #"res://scenes/libelula9.tscn",
		   #"res://scenes/libelula10.tscn"
	]
